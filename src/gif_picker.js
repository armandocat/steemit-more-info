...
(function () {
  ...
  window.SteemMoreInfo.Utils.addSettings({
    ...
    settings: [{
      ...
      description: 'Tool to easily add GIF from <a href="https://giphy.com/" target="_blank" rel="noopener">giphy.com</a> to posts and comments <img src="https://i.imgsafe.org/e6/e67c07abe2.png">'
    }]
  });
