...
(function () {
  ...
  var setupIframe = function(iframeWindow, doc){
    ...
    html.on('click', 'a', function(e) {
      ...
      if(ctorig && ctorig.startsWith('https://steemit.com/')) {
        window.SteemMoreInfo.Utils.navigate(ctorig);
      }else{
  ...
  var _openSearch = function(container, search) {
  ...
  var replaceHeaderSearch = function() {
